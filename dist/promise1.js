...
/***/ function(module, exports, __webpack_require__) {
	...
	**/
	...
	function resolve(promise, value) {
		...
		if (promise === value) {
			...
			if (value._status == FULFILLED) {
				...
				value._fulfillArr.push(function (value) {
					resolve(promise, value);
				});
				value._rejectArr.push(function (reason) {
					reject(promise, reason);
				});
			}
	...
	function handleThenable(promise, value, then) {
		var settled = false; // 是否fulfilled或rejected
		try {
			then.call(value, function (otherValue) {
				if (settled) {
					return;
				};
			...
			value: function then(onFulfilled, onRejected) {
				...
				if (this._status !== PENDING) {
					if (this._status == FULFILLED) {
						asyncCall(function () {
							dealThen(_this, child, onFulfilled);
						});
					} else {
						asyncCall(function () {
							dealThen(_this, child, onRejected);
						});
					}
				} else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function isObjectOrFunction(x) {
		return isFunction(x) || (typeof x === 'undefined' ? 'undefined' : (0, _typeof3.default)(x)) === 'object' && x !== null;
	}
